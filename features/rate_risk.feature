Feature: Add risk and rate it
  ...
  Scenario Outline: Rate risk branch
    ...
    Examples:
      ...
      | Anton | temp.test.risk@gmail.com | 99999999 | Project_Name_Anton | risk_for_rate | 8           | 8      | 100   | 10   |
      | Anton | temp.test.risk20@mail.ru | 99999999 | Project_Name_Anton | risk_for_rate | 2           | 2      | 4     | 2    |
