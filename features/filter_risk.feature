Feature: Filter risk
  ...
  Scenario Outline: Filter risks by category
    ...
    Examples:
      ...
      | temp.test.risk5@gmail.com | 99999999 | Project_Name_Anton | Category_1 | temp_name_1 |
      | temp.test.risk5@gmail.com | 99999999 | Project_Name_Anton | Category_2 | temp_name_2 |
